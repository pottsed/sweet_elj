    ...
    <div class="col-sm-4">
        <div class="register-box">
            <div class="login-logo">
                <a href=""><b>Sweet</b>ELJ | <small>Register</small></a>
            </div>
            <div class="card card-outline card-primary">
                <div class="card-body">
                    ...
                    <?php echo form_error('nama_pelanggan', '<div class="text-danger small ml-2">', '</div>') ?>
                    <div class="input-group mb-3">
                        <input type="text" name="nama_pelanggan" value="<?= set_value('nama_pelanggan') ?>" class="form-control" placeholder="Nama Anda">
                    ...
                    <?php echo form_error('ulangi_password', '<div class="text-danger small ml-2">', '</div>') ?>
                    <div class="input-group mb-3">
