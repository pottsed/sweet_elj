                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <?php } else { ?>
                                            ...
                                            <span class="badge bg-lightblue disabled">Menunggu verifikasi</span>
                                        <?php } ?>
                                    </td>
                                    <td>
                                        <?php if ($value->status_bayar == 0) { ?>
                            ...
                            <?php foreach ($diproses as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <span class="badge bg-lightblue disabled">Diproses</span>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
                            ...
                            <?php foreach ($dikirim as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button data-toggle="modal" data-target="#diterima<?= $value->id_transaksi ?>" class="btn bg-teal btn-xs btn-flat">Diterima</button>
                                    </td>
                                </tr>
                            <?php } ?>
                        </table>
