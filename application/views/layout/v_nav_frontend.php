 ...
 <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
     <div class="container">
         <a href="<?= base_url() ?>" class="navbar-brand">
             <img src="<?= base_url() ?>template/dist/img/Logoo.png" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8" width="35px" height="20px">
             <span class="brand-text font-weight-light"><b>Sweet Elj</b></span>
         </a>
         ...
         <div class="collapse navbar-collapse order-3" id="navbarCollapse">
             ...
             <ul class="navbar-nav">
                 ...
                 <?php $bahan = $this->m_home->get_all_data_bhn() ?>
                 <li class="nav-item dropdown">
                     <a id="dropdownSubMenu2" href="#" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" class="nav-link dropdown-toggle">Bahan</a>
                     <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                         <?php foreach ($bahan as $key => $value) { ?>

                             <li><a href="<?= base_url('home/bahan/' . $value->id_bahan) ?>" class="dropdown-item"><?= $value->nama_bahan; ?></a></li>
             ...
             <ul class="order-1 order-md-3 navbar-nav navbar-no-expand ml-auto">
                 ...
                 <?php $keranjang = $this->cart->contents();
                    //untuk menampilkan jumlah di keranjang
                    $jml_item = 0;
                 ...
                 <li class="nav-item">
                     <?php if ($this->session->userdata('email') == "") { ?>
                         <a class="nav-link" href="<?= base_url('pelanggan/login') ?>">
                             ...
                             <img src="<?= base_url('assets/foto/fotoo.png') ?>" alt="Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
                         </a>
                     <?php } else { ?>
             ...
             <div class="row mb-2">
                 ...
                 <div class="col-sm-6">
                     <ol class="breadcrumb float-sm-right">
                         <li class="breadcrumb-item"><a href="#">Sweet Elj</a></li>
